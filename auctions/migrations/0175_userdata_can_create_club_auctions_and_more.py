...
* Double bag corys, loaches, and other fish with sharp spines, because their spines can poke through some bags.
...
def reverse_func(apps, schema_editor):
    # right now, the database creation stuff doesn't get rolled back
    pass
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("post_office", "0011_models_help_text"),  # Ensure post_office migrations are applied first
    ]

    operations = [
        migrations.RunPython(create_faqs, reverse_func),
        migrations.RunPython(create_or_update_email_templates, reverse_func),
        migrations.RunPython(create_categories, reverse_func),
        migrations.RunPython(create_or_update_blog_posts, reverse_func),
        migrations.AddField(
            model_name="userdata",
