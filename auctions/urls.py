...
urlpatterns = [
    ...
    path("api/ignore_auction/", views.IgnoreAuction.as_view()),
    path(
    ...
    path("auctions/all/", views.AllAuctions.as_view(), name="all_auctions"),
    ...
    path("auctions/<slug:slug>/invoices/", login_required(views.AuctionUsers.as_view()), name="auction_invoices"),
    path(
    ...
    path(
        ...
        views.AuctionInvoicesPayPalCSV.as_view(),
        name="paypal_csv",
    ),
