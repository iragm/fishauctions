...
urlpatterns = [
    ...
    path('auctions/<slug:slug>/print/user/<str:username>/', views.LabelViewForAuctionAdmins.as_view()),
    path('auctions/<slug:slug>/print/bidder/<str:bidder_number>/', views.LabelViewForAuctionAdmins.as_view(), name="print_labels_by_bidder_number"),
