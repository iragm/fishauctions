...
urlpatterns = [
    ...
    path('auctions/<slug:slug>/invoice/', login_required(views.InvoiceView.as_view()), name='my_auction_invoice'),
    ...
    path('api/auctionstats/<slug:slug>/lot_sell_price', views.AuctionStatsLotSellPricesJSONView.as_view(), name='auction_sell_prices'),
    path('api/auctionstats/<slug:slug>/auction_funnel_chart', views.AuctionFunnelChartData.as_view(), name='auction_funnel_chart'),
    path('api/auctionstats/<slug:slug>/auction_lot_bidders', views.AuctionLotBiddersChartData.as_view(), name='auction_lot_bidders'),
    path('api/auctionstats/<slug:slug>/auction_lot_categories', views.AuctionCategoriesChartData.as_view(), name='auction_lot_categories'),
