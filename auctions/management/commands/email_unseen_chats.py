...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        users = User.objects.filter(userdata__email_me_when_people_comment_on_my_lots=True, lot__lothistory__seen=False, lot__lothistory__changed_price=False).distinct()
